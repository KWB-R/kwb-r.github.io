	//Cloned from https://usgs-r.github.com (revision 357)
    ...
    (function ($, undefined) {
      ...
      function addRepos(repos, page) {
        ...
        var uri = "https://api.github.com/orgs/KWB-R/repos?callback=?"
                + "&per_page=100"
                + "&page="+page;
      ...
      //get total number of members of the KWB-R organization
      function getNumMembers(page, numMembers) {
        var page = page || 1;
        var numMembers = numMembers || 0;
        var membersUri = "https://api.github.com/orgs/KWB-R/members?callback=?"
          + "&per_page=100"
          + "&page="+page;
